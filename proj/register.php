...
if (isset($_POST['signup'])) {
	...
	if (!$error) {
		if(mysqli_query($con, "INSERT INTO people(name,email,password) VALUES('" . $name . "', '" . $email . "', '" . md5($password) . "')")) {
 ...
 <nav class="navbar navbar-inverse">
  ...
  <div class="input-group">
    ...
    <ul class="nav navbar-nav navbar-right">
				...
				<?php } else { ?>
				 <li><a class="active" href="register.php"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
